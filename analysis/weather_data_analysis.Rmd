...
plot(ce_temps_yr_ts, main = paste("Temps with LL est, 95% SCB, and model fits since 1850"), 
     col = alpha("black", 0.5), xlim = c(1850, 2020))
...
lines(as.numeric(time(ce_temps_post_1850)), predict(object = mdl_cubic), lwd = 2, lty = 2, col = "orange3")
lines(as.numeric(time(ce_temps_post_1850)), mdl_iso$yf, lwd = 2, lty = 3, col = "black")
legend("bottomright", legend = c("SCB", "Linear", "Quadratic", "Cubic", "Isotonic"), 
       col = c("coral", "purple", "green2", "orange3", "black"), lty = c(2,2,2,2,3))
