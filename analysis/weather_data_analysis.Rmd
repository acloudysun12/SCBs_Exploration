...
plot(ce_temps_q1_ts, xlim = c(1850, 2020), 
     main = paste("Q1 temps with LL est. and SCB for optimal b = ", round(k_final_q1/360, 3)))
...
plot(ce_temps_q2_ts, xlim = c(1850, 2020), 
     main = paste("Q2 temps with LL est. and SCB for optimal b = ", round(k_final_q2/360, 3)))
...
plot(ce_temps_q3_ts, xlim = c(1850, 2020), 
     main = paste("Q3 temps with LL est. and SCB for optimal b = ", round(k_final_q3/360, 3)))
...
plot(ce_temps_q4_ts, xlim = c(1850, 2020), 
     main = paste("Q4 temps with LL est. and SCB for optimal b = ", round(k_final_q4/360, 3)))
