...
__`r paste(round(c(k_final_0, k_final_lo, k_final_hi), 3), collapse = ", ")`__ <br>
...
## Calculate optimal bandwidth (Ruppert 1995) for temperature series by quarter <br>
